...
const helpers = require('../_helpers')
  ...
  router.get('/restaurants/:id/dashboard', authenticated, restController.dashboard)
  ...
  router.get('/users/:id', authenticated, userController.proFile)
  router.get('/users/:id/edit', authenticated, userController.editProFile)
  router.put('/users/:id', authenticated, upload.single('image'), userController.putEditProFile)
